...
class TeacherAcademicCalendarView extends StatelessWidget {
  const TeacherAcademicCalendarView({super.key});
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Card(
                              ...
                              child: InkWell(
                                onTap: () => context.go(
                                  '/teacher-dashboard/calendar/${academicYear.year}',
                                ),
                                borderRadius: BorderRadius.circular(12),
                                child: Padding(
                                  padding: const EdgeInsets.all(16),
